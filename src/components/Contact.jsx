...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-gray-900 to-purple-900 text-white relative overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/2">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-purple-900 transition-all"
              >
                <Linkedin size={20} />
              </a>
              <a
          ...
          <div className="lg:w-1/2">
            ...
            >
              <h3 className="text-2xl font-bold mb-6 text-wine">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 rounded-xl border border-gray-200 focus:border-purple-primary focus:ring-2 focus:ring-purple-primary/20 outline-none transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-wine to-purple-primary text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                >
                  <Send size={20} />
